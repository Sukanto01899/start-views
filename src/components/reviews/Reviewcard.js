...
const Reviewcard = (props) => {
    ...
    return (
        <div className='border w-56 shadow-lg rounded-md'>
            <div className='flex items-center mt-4 ml-3'>
                <div className='w-12 h-12 mr-3'><img className='w-full rounded-full object-contain overflow-hidden' src={picture} alt="" /></div>
